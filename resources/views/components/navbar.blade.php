        ...
        <div class="container ">
            <nav class="navbar navbar-light navbar-expand-lg container-fluid p-0 ">
                    ...
                    <a class="navbar-brand d-flex align-items-center " href="{{ route('home') }}">
                        <img src="{{asset('Logo/Logo2.jpg')}}" class="img-fluid" style="height: 50px" alt="resources/images/Logo">
                            ...
                            <ul class="navbar-nav mx-auto text-center ">
                                <li class="nav-item dropdown my-auto ">
                                    ...
                                    @foreach ($categories as $category)
                                            <li>
                                                <a class="dropdown-item nav-link nav-item  text_color_body" href="{{ route('category.show', $category) }}">
