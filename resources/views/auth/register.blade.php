                ...
                <div class=" card mt-3  ">
                    ...
                    <div class=" card-body ">
                        <form action="/register" method="POST">
                            ...
                            <div class="row g-3 ">
                                <div class="col-12">
                                    <label for="name" class="text-white">Inserisci il tuo nome</label>
                                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value=" {{ old('name') }} ">
                                    @error('name') <span class=" text-danger small "> {{ $message }} </span>  @enderror
                                </div>
                                <div class="col-12">
                                    <label for="email" class="text-white">Inserisci la tua Email</label>
                                    <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value=" {{ old('email') }} ">
                                    @error('email') <span class=" text-danger small "> {{ $message }} </span>  @enderror
                                </div>
                                <div class="col-12">
                                    <label for="password" class="text-white">Inserisci Password</label>
                                ...
                                <div class="col-12">
                                    <button type="submit" class=" btn btn-primary text-white "> Registrati
                                    </button>
                                </div>
                            </div>
                        </form>
